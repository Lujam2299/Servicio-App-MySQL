        ...
        <main class="flex flex-1 overflow-auto">
          ...
          <div class="flex flex-col flex-1 p-6 overflow-hidden">
            <div class="flex items-center justify-between">
              <h1 class="text-3xl font-semibold text-gray-700 dark:text-gray-200">Configuración del perfil</h1>
            </div>
            <div class="flex flex-col mt-6">
              <div class="flex flex-col mt-6">
                <div class="flex flex-col mt-4">
                    <p class="font-semibold text-gray-700 dark:text-gray-200">Aquí se mostrarán tus opciones de configuración.</p>
                </div>
              </div>
            </div>
          </div>
